<template>
  <v-container class="grey lighten-5 pb-15">
    ...
    <p class="text-h5 font-weight-bold pt-5">ログイン情報の管理</p>
    <p class="pt-2">
    ...
    <p class="text-h5 font-weight-bold pt-5">コンテンツのご利用</p>
    <p class="pt-2">
    ...
    <p class="text-h5 font-weight-bold pt-5">ユーザーの投稿</p>
    <p class="pt-2">
      ...
      ユーザーの投稿に関する著作権は、ユーザー自身に留保されます。当社はユーザーの投稿に関して著作権を取得することはありません。ただし、当社は、本サービスの提供、維持、改善又は本サービスのプロモーションに必要な範囲において、無償、無期限かつ地域非限定で、ユーザーの投稿を複製、翻案、自動公衆送信及びそのno必要な送信可能化をすることができるものとします。この場合、ユーザーは、当社および当社から権利を承継し又は許諾されたものに対し著作者人格権を行使しないものとします。
    ...
    <p class="text-h5 font-weight-bold pt-5">広告の表示</p>
    <p class="pt-2">
      当社は、本サービスに第三者の広告を掲載することができるものとします。
    </p>
    <p class="text-h5 font-weight-bold pt-5">禁止事項</p>
    <p class="pt-2">
    ...
    <p class="text-h5 font-weight-bold pt-5">反社会的勢力の排除</p>
    <p class="pt-2">
    ...
    <p class="text-h5 font-weight-bold pt-5">利用制限</p>
    <p class="pt-2">
    ...
    <p class="text-h5 font-weight-bold pt-5">本サービスの提供の停止</p>
    <p class="pt-2">
    ...
    <p class="text-h5 font-weight-bold pt-5">個人情報の取り扱い</p>
    <p class="pt-2">
      本サービスの利用によって取得するユーザーの個人情報については、当社のプライバシーポリシーに従い適切に取り扱うものとします。
    </p>
    <p class="text-h5 font-weight-bold pt-5">通知または連絡</p>
    <p class="pt-2">
      ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
    </p>
    <p class="text-h5 font-weight-bold pt-5">権利義務の譲渡</p>
    <p class="pt-2">
    ...
    <p class="text-h5 font-weight-bold pt-5">事業譲渡</p>
    <p class="pt-2">
    ...
    <p class="text-h5 font-weight-bold pt-5">適用関係</p>
    <p class="pt-2">
